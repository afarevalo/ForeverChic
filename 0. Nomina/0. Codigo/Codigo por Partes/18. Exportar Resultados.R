...
rm(header_style,datos_trabajador, Data_Alianza, Data_Spa, Data_Tocador,
   base_datos,accounting_style)
rm(yellow_row_style)
rm(alianza, wb, trabajador, suma_negativos, suma_positivos, ruta_archivo, tocador, spa, 
   ruta_resultados, revisar, nombre_carpeta, fila, filas_negativas, fila, col_index, cadena_carpeta)
