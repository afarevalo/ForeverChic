...
# Reemplazar NA en val_prod con 0 para evitar problemas en la operación
Data$val_prod <- ifelse(is.na(Data$val_prod), 0, Data$val_prod)
...
Data$Part_profesional <- ifelse(Data$`Nombre cliente` %in% Base_Profesionales, 0, 
