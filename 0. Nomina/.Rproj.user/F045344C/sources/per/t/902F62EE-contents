...
# tryCatch({
  ...
  source("0. Codigo/Codigo por Partes/12. Porcentaje de los Profesionales.R")
  source("0. Codigo/Codigo por Partes/13. Participación Salón.R")
  source("0. Codigo/Codigo por Partes/14. Descuento Ajuste Producto.R")
  source("0. Codigo/Codigo por Partes/15. Descuentos Varios a Profesionales.R")
  source("0. Codigo/Codigo por Partes/16. Exportar Resultados.R")
# }, error = function(e) {
