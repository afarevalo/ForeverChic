...
cadena_carpeta <- paste0(". resultados ", MES1, " ",  MIN, " al ", MES2, " ", MAX)
numero_formateado <- sprintf("%02d", numero_extraido)
nombre_carpeta <- paste0(numero_formateado, cadena_carpeta)

# Crear la carpeta de Resultados
ruta_resultados <- file.path("3. Resultados", nombre_carpeta)
